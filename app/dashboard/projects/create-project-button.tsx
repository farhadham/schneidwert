...
const mutationService = mainApiClient.api.projects.$post;
...
export default function CreateProjectButton() {
  ...
  const { mutate, isPending } = useApiMutation({
    mutationFn: (data: InferRequestType<typeof mutationService>["json"]) =>
      handleRpcResponse(mutationService({ json: data })),
    onCustomSuccess: () => {
      setOpen(false);
    },
    invalidateQueryKeys: projectQueryKeys.all,
  });
      ...
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription className="sr-only">
            Fill information about the new project.
          </DialogDescription>
        </DialogHeader>
